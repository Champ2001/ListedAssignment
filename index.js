...
]; //Line number 9-14 for  declaring scopes
...
app.get('/', async (req, res) => {
    ...
    async function main(){
        ...
        setInterval(async() => {
            ...
            for(const message of messages){
                ...
                console.log(`Added reply to message with id ${message.id}`);
            }
    ...
    res.send("You have successfully subscribed to our service .Thank you!");
}
);
